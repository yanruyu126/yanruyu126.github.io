        ...
        <div style={{display:'flex', flexDirection: "row", width:"100%"}}>
          ...
          <div style={{width:'30%'}}>
            <a href={"https://www.cs.cornell.edu/abe/projects/recapture/"} className="image">
              <img src={`${process.env.PUBLIC_URL}${'/images/projects/recapture.png'}`} alt={'ReCapture: AR-Guided Timelapse Photography'} width='100%'/>
            </a>
          </div>
        </div>
      ...
      desc:
        <div>
          ...
          <div style={{display: "flex", flexDirection: "row", alignContent: "center", justifyContent: "space-evenly"}}>
            <div className='player-wrapper' style={{width:"72%", paddingRight:"10px"}}>
              <ReactPlayer
            ...
            <div style={{flexDirection: "column", width:"26%"}}>
    ...
    },
    {
      ...
      desc:
        <div>
          ...
          <p className='caption'>Example Outputs: crop mask (left), image alignment and crop detection (right)</p>
        </div>,
      collaborators:  <p>
      ...
      desc:
        <div>
          ...
          <div style={{display: "flex", flexDirection: "row", justifyContent: "space-evenly", alignItems: 'center'}}>
            <div className='player-wrapper' style={{width:"60%"}}>
              <p className='caption'>5x Fast-forwarded Demo Video</p>
              <ReactPlayer
                className='react-player'
            ...
            <div style={{display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", width:"35%"}}>
              <p className='caption'>Example Outputs</p>
              <div style={{display: "flex", flexDirection: "row", width:"100%"}}>
                <img style={{width:"50%"}} src={`${process.env.PUBLIC_URL}${'/images/projects/paper_cut_1.png'}`} />
                <img style={{width:"50%"}} src={`${process.env.PUBLIC_URL}${'/images/projects/paper_cut_2.png'}`} />
              </div>
              <div style={{display: "flex", flexDirection: "row", width:"100%"}}>
                <img style={{width:"50%"}} src={`${process.env.PUBLIC_URL}${'/images/projects/paper_cut_3.png'}`} />
                <img style={{width:"50%"}} src={`${process.env.PUBLIC_URL}${'/images/projects/paper_cut_4.png'}`} />
              </div>
            </div>
          </div>
        </div>,
        ...
        <div>
          ...
          <div style={{display: "flex", flexDirection: "row", justifyContent: "space-evenly", alignContent: 'center'}}>
            <div style={{display: 'flex', flexDirection: "column", width:"32%"}}>
              <p className='caption'>Dolly Zoom and Camera Rotation</p>
              <ReactPlayer
                className='react-player'
            ...
            <div style={{display: 'flex', flexDirection: "column", width:"32%"}}>
              <p className='caption'>Customized Re-lighting</p>
              <ReactPlayer
                className='react-player'
            ...
            <div style={{display: 'flex', flexDirection: "column", width:"32%"}}>
              <p className='caption'>Face Painting</p>
              <ReactPlayer
                className='react-player'
